...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด? 
    - การปรับตั้งค่ากราฟใน Excel เพื่อเรียกแสดงสมการ Polynomial และการแปลงสมการคณิตศาสตร์จากกราฟมาเขียนเป็นโค้ดภาษา C

2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? 
    - จะเพิ่มจำนวนจุดในการเก็บข้อมูลสภาพแสงให้ถี่ขึ้น (เช่น 7–10 จุด) เพื่อให้ได้เส้นแนวโน้มสมการ Calibration ที่ครอบคลุมและแม่นยำยิ่งขึ้น

3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? 
    - การต่อวงจร Voltage Divider เพื่อแปลงค่าความต้านทานเป็นแรงดันไฟฟ้า และการเลือกใช้สมการ Polynomial ที่เหมาะกับคุณสมบัติของ LDR
